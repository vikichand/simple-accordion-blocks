...
/**
 * Plugin Name: Simple Accordion Blocks
 * Plugin URI: https://wordpress.org/plugins/simple-accordion-blocks
 * Description: Simple Gutenberg blocks for creating responsive accordions.
 * Version: 1.1.0
 * Author: Vikash Chand
...
if (!class_exists('VC_Accordion_Blocks')) :

	class VC_Accordion_Blocks
	{
		...
		public function register_block()
		{
			...
			wp_register_script(
				'vc-simple-accordion-blocks-script',
			...
			wp_register_style(
				'vc-simple-accordion-blocks-style',
				plugins_url('build/index.css', __FILE__),
				array(),
				$asset_file['version']
			);

			register_block_type('vc/accordion-item', array(
				'editor_script' => 'vc-simple-accordion-blocks-script',
				'style'         => 'vc-simple-accordion-blocks-style',
			));
		}
		...
		public function enqueue_frontend_assets()
		{
			...
			wp_enqueue_script(
				'vc-simple-accordion-blocks-frontend-script',
				plugins_url("js/simple-accordion-blocks$min.js", __FILE__),
				array('jquery'),
				$this->plugin_version,
				true
			);
		...
		public function add_documentation_link($links)
		{
			array_push($links, sprintf(
				'<a href="%s">%s</a>',
				'http://wordpress.org/plugins/simple-accordion-blocks/',
				_x('Documentation', 'link to documentation on wordpress.org site', 'simple-accordion-blocks')
			));

			array_push($links, sprintf(
				'<a href="%s">%s</a>',
				'https://vikash.ch/',
				__('Author', 'simple-accordion-blocks')
			));
		...
		{
			register_rest_route('simple-accordion-blocks/v1', '/defaults', array(
	...
	$VC_Accordion_Blocks = new VC_Accordion_Blocks;
